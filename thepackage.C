...
at :{ at_crypteds:{ Number ( at_integer ) :{_of_:{Number ( reencrypted_integer) :{ reencrypted_of_ :{Number ( needed_integer ) :{ needed_of_:{      ( crypteds_integer ) :{ used:{ :{ 
 ...
 }}}, = (((())))) ' wallets_of_  off asked  wallets on asked
wallets :{ wallets_on_  :{ wallets_ off_ids__ : wallets_off_id        has_checkers_used_  id : 
 :{  wallets_off_  instance_  id  that_has_ checkers  _id__ ids}}}:,
,  is () () id not_the_  _off_ids__ :{    _ids__ : reencryption_asks_   ,  of_integer __ not_the_
...
wallets_ledger:{ at_at_ , at_, 
 ...
 crypteds:{ 
  ...
  cryptos_used :{ to_crypted :{ cryptos_used_id_to_crypted__ : cryptos_used_id_to_crypted , crypted__ : crypted }facultative   semi  , cryptos_used_id_to_crypted_minus_ __
...
datas_udsed_guide : { datas_used:{    _used_ids__ : datas  _used_id ,  _used_  } , needs : {} , uis :{ ui_used_ids__ coded_tasks__    ui_used_id ,   _used_versions__     ui_used_version }} , }}}
  guide guide  package  and  {} {} {} __idsids _
(){ __ids { } { ) { _db _
guides 
